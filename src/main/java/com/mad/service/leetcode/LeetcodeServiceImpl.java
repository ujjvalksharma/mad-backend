...
// Reference: https://github.com/JeremyTsaii/leetcode-stats-api/blob/main/src/main/java/leetcode/api/service/StatsServiceImpl.java
@Service
public class LeetcodeServiceImpl implements LeetcodeService {
    @Override
    public LeetcodeUserDetails getLeetcodeUserDetails(String username) {
 ...
 return null;
    ...
    private LeetcodeUserDetails decodeGraphqlJson(JSONObject json) {
        int totalSolved = 0;
        ...
        return new LeetcodeUserDetails("success", "retrieved", totalSolved, totalQuestions, easySolved, totalEasy, mediumSolved, totalMedium, hardSolved, totalHard, acceptanceRate, ranking, contributionPoints, reputation, submissionCalendar);
    }
